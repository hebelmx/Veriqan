...
/// <summary>
/// Liskov Substitution Principle verification tests for <see cref="ContextualDocxStrategy"/>.
/// </summary>
/// <remarks>
/// <para>
/// These tests prove that ContextualDocxStrategy correctly implements <see cref="IAdaptiveDocxStrategy"/>
...
/// </para>
/// </remarks>
public sealed class ContextualDocxStrategyLiskovTests
{
    private readonly ITestOutputHelper _output;
    private readonly ILogger<ContextualDocxStrategy> _logger;

    // Sample document with contextual clues (labeled sections, keywords)
    ...
    public ContextualDocxStrategyLiskovTests(ITestOutputHelper output)
    {
        _output = output;
    ...
    public void StrategyName_ShouldReturnNonEmptyString_Liskov()
    {
        ...
        strategyName.ShouldBe("ContextualDocx");
    }
    ...
    public async Task ExtractAsync_ShouldHandleCancellation_Liskov()
    {
        ...
        await Should.ThrowAsync<OperationCanceledException>(async () =>
            await strategy.ExtractAsync(ValidContextualDocx, cts.Token));
    }
    ...
    public async Task CanExtractAsync_ShouldReturnTrue_WhenStrategyCanHandleDocument_Liskov()
    {
        ...
        // Act
        var canExtract = await strategy.CanExtractAsync(ValidContextualDocx, TestContext.Current.CancellationToken);
