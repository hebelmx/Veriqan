# ⚠️ Code Quality Audit: `extraction`
...
| **🏷️ Class** | RequirementSummary |
| **⚙️ Method** | extraction |
| **📍 Line** | 49 |
| **🔍 Pattern** | `magic_numbers` |
| **📂 Category** | 🔧 Hardcoded Values |
| **📁 File** | `RequirementSummary.cs` |
| **🧪 Is Test** | ❌ No |
...
**File Path:** `Domain\ValueObjects\RequirementSummary.cs`
...
### 🎯 Batch Information
- **Batch ID:** B013_ExxerCube_Prisma_Domain_ValueO_2
