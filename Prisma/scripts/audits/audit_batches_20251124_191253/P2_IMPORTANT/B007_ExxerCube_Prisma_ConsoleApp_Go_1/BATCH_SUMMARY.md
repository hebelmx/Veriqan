...
- ⚠️ **Poor Exception Handling**: 3 issues
...
- `ConsoleApp.GotOcr2Demo\Program.cs` (Line 80)
- `ConsoleApp.GotOcr2Demo\Program.cs` (Line 124)
- `ConsoleApp.GotOcr2Demo\Program.cs` (Line 168)
