...
|-------|-------|
| **🎯 Severity** | ⚠️ MEDIUM |
| **📦 Project** | Infrastructure.BrowserAutomation |
| **🏗️ Namespace** | ExxerCube.Prisma.Infrastructure.BrowserAutomation |
| **🏷️ Class** | PlaywrightBrowserAutomationAdapter |
| **⚙️ Method** | catch |
| **📍 Line** | 80 |
| **🔍 Pattern** | `generic_exception_catch` |
| **📂 Category** | ⚠️ Poor Exception Handling |
| **📁 File** | `PlaywrightBrowserAutomationAdapter.cs` |
| **🧪 Is Test** | ❌ No |
...
**File Path:** `Infrastructure.BrowserAutomation\PlaywrightBrowserAutomationAdapter.cs`
...
**Layer:** 🔌 ADAPTER (Infrastructure.BrowserAutomation) - Browser automation services
...
- **Namespace Group:** ExxerCube.Prisma.Infrastructure.BrowserAutomation
- **Item:** 2 of 5
