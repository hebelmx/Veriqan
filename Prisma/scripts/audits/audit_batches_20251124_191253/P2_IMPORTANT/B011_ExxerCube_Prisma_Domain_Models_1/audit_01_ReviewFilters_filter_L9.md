...
| **🎯 Severity** | ⚠️ MEDIUM |
| **📦 Project** | Models |
| **🏗️ Namespace** | ExxerCube.Prisma.Domain.Models |
| **🏷️ Class** | ReviewFilters |
| **⚙️ Method** | filter |
| **📍 Line** | 9 |
| **🔍 Pattern** | `magic_numbers` |
| **📂 Category** | 🔧 Hardcoded Values |
| **📁 File** | `ReviewFilters.cs` |
| **🧪 Is Test** | ❌ No |
...
**File Path:** `Domain\Models\ReviewFilters.cs`
...
- **Namespace Group:** ExxerCube.Prisma.Domain.Models
- **Item:** 1 of 2
