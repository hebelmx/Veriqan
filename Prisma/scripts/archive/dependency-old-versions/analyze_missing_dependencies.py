#!/usr/bin/env python3
"""
Analyzes CS0246 errors to find missing dependencies and their sources.
...
class MissingDependencyAnalyzer:
    """Analyzes CS0246 errors and finds where missing types are defined."""
    ...
    def __init__(self, base_path: str):
        ...
        self.known_type_namespaces = {
            ...
            'Program': 'Microsoft.AspNetCore.Hosting',  # For test projects
            ...
            # Playwright
            'IPlaywright': 'Microsoft.Playwright',
            'IBrowser': 'Microsoft.Playwright',
            'IPage': 'Microsoft.Playwright',
            'IBrowserContext': 'Microsoft.Playwright',
            'ILocator': 'Microsoft.Playwright',
            ...
            'UglyToad': 'PdfPig',  # UglyToad is namespace in PdfPig
            
            # Google Drive
            'DriveService': 'Google.Apis.Drive.v3',
            'GoogleCredential': 'Google.Apis.Auth.OAuth2'
        }
        ...
        self.namespace_to_package = {
            ...
            'System.Text.RegularExpressions': None,  # Part of BCL
            'System.Text': None,  # Part of BCL
            'System.IO': None,  # Part of BCL
            'System.Diagnostics': None,  # Part of BCL
            'System.Collections.Generic': None,  # Part of BCL
            'System.Threading': None,  # Part of BCL
            'System.Threading.Tasks': None,  # Part of BCL
            'System.Net.Http': None,  # Part of BCL in .NET Core/5+
            ...
            'NPOI': 'NPOI',
            'PdfPig': 'PdfPig',
            'PdfSharp': 'PDFsharp',  # Note: package name is PDFsharp
            'OpenCvSharp4': 'OpenCvSharp4',
            'YamlDotNet': 'YamlDotNet',
            
            # Google APIs
            'Google.Apis.Drive.v3': 'Google.Apis.Drive.v3',
            'Google.Apis.Auth.OAuth2': 'Google.Apis.Auth',
    ...
    def parse_error_file(self, error_file: str) -> List[Dict]:
        ...
        cs0246_count = sum(1 for e in errors if e.get('error_code') == 'CS0246')
        cs0103_count = sum(1 for e in errors if e.get('error_code') == 'CS0103')
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Analyze CS0246 errors and find missing dependencies')
